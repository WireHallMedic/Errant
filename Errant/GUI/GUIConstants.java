...
public interface GUIConstants
{
   ...
   // color groups
   public static final Color[] DULL_RED_GROUP = {new Color(160, 58, 62), new Color(201, 69, 73), new Color(243, 82, 84)};
   ...
   public static final Color[] YELLOW_GROUP = {new Color(120, 103, 7), new Color(168, 148, 32), new Color(234, 255, 0)};
   public static final Color[] ORANGE_GROUP = {new Color(227, 107, 28), new Color(255, 120, 0), new Color(255, 192, 32)};
   public static final Color[] PURPLE_GROUP = {new Color(82, 30, 103), new Color(127, 59, 164), new Color(199, 104, 252)};
   public static final Color[] BLACK_GROUP = {new Color(61, 61, 61), new Color(89, 89, 89), new Color(150, 150, 150)};
   public static final Color[] WHITE_GROUP = {new Color(145, 145, 145), new Color(201, 201, 201), new Color(243, 243, 243)};
   public static final Color[] GREY_GROUP = {new Color(89, 89, 89), new Color(145, 145, 145), new Color(189, 189, 189)};
   public static final Color[] METAL_GROUP = {new Color(105, 105, 105), new Color(144, 144, 144), new Color(201, 201, 201)};
